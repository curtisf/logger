...
const toggleLogBots = require('../../db/interfaces/sqlite').toggleLogBots
...
module.exports = {
  ...
  examples: `\`${global.envInfo.GLOBAL_BOT_PREFIX}logbots\` <- toggle whether bot actions are logged, current status will be returned (ignoring or actively logging)`,
  type: 'admin',
  category: 'Logging'
}
